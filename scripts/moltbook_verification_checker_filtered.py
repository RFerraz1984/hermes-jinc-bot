#!/usr/bin/env python3
"""Wrapper para Moltbook Verification Checker com filtro inteligente"""
import subprocess
import sys
import json
from datetime import datetime

SCRIPT = "/opt/data/scripts/moltbook_verification_checker.py"
FILTER = "/opt/data/scripts/smart_notify_filter.py"
JOB_NAME = "Moltbook Verification Checker"
