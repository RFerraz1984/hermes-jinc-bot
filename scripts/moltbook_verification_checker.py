...
def solve_math_challenge(challenge_text):
    ...
    # Pattern: "LoBbStEr ClAw FoRcE Is ThIrTy FiVe NeWToNs AnD MoLtInG InCrEaSeS ItS FoRcE By FoUr TiMeS WhAt Is ThE NeW ToTaL FoRcE"
    # or "lOoObSsTtEeR sW-iMmS iN tHrEe lAyErS oF wAtEr uMm aNd lOoosE lyEe bAlAnCe ItS veLlAwcItEe Is tW/eNtY fIvE mEtErS pEr MiNuTe aNd iT aCcElErAtEs bY sEeVEn mEtErS pEr MiNuTe HoW qUiCkLy wIlL iT sWiMm nOw"
    ...
    if len(numbers) >= 2:
        ...
        if "times" in text_lower or "multipl" in text_lower or "multiply" in text_lower:
            ...
            # Force * distance
            result = numbers[0] * numbers[1] / 100  # cm to m
        else:
            # Default: add
            result = numbers[0] + numbers[1]
    ...
    # Fallback: try to use the solve-verification helper logic
    return "0.00"
